package com.example.worddef_fragment.fragment.fragmentWordSet.elements.view.txtView;
...
public class SuperTxtViewRght extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public SuperTxtViewRght(@NonNull Context context, String txt) {
        super(context);
        onCreate();
        setText(txt);
        this.txt=txt;
