...
import com.example.worddef_fragment.fragment.fragmentWordSet.elements.view.txtView.TxtViewWrdSetLft;
        ...
        switch (menuItem.getItemId()) {
            ...
            case 1:
                ...
                dialogDeleteSet.setButton(AlertDialog.BUTTON_POSITIVE, "DELETE",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                new FragmentOperatorFactory().create("wordset", view.getContext()).remove(view.getSetName());
