package com.example.worddef_fragment.fragments.fragmentWordSet;
...
import com.example.worddef_fragment.fragments.fragmentWordSet.elements.btn.BtnMenuTop;
...
public class FragmentWordSet extends Fragment
{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        pBarWordSet.setEnabled(false);
        pBarWordSet.setVisibility(View.INVISIBLE);
